...
/**
 * Created by WeiYanGeorge on 2016-10-31.
 */

public class SecondPagesItem6Delegate implements ItemViewDelegate<Content> {

    private Context context;
    private ImageView iv_info_cover;
    int width = SizeUtils.getScreenWidth();
    int height = SizeUtils.dpToPx(300);

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_fifth_secondpages;
    }
