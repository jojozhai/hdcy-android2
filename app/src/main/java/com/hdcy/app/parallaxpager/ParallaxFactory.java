...
public class ParallaxFactory implements LayoutInflater.Factory {
    ...
    protected void onViewCreated(View view, Context context, AttributeSet attrs) {
        ...
        int[] attrIds =
                { R.attr.a_in, R.attr.a_out, R.attr.x_in, R.attr.x_out, R.attr.y_in, R.attr.y_out, R.attr.s_int,R.attr.s_out };
        ...
        if (a != null) {
            if (a.length() > 0) {
                ...
                tag.scaleIn = a.getFloat(6, 1f);
                tag.scaleOut = a.getFloat(7, 1f);
